...
if (isset($_POST["MM_register"]) && $_POST["MM_register"] == "formRegister") {
    ...
    if ($existingUser) {
        ...
        $userRegistered = registerUser($connection, $documento, $nombreCompleto, $nombreUsuario, null, $user_password, $idRol, $genero, $estadoUsuario, $correoElectronico, $tipoDocumento);
