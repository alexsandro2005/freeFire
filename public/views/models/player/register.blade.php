...
<body onload="limitarFechas()"> 
    ...
    <main>
        ...
        <form method="POST" name="formreg" enctype="multipart/form-data" action="" autocomplete="off"
            ...
            <div class="formulario__grupo" id="grupo__document">
                ...
                <div class="formulario__grupo-input">
                    <input type="number" minlength="6" onkeypress="return(multiplenumber(event));" maxlength="10"
                        oninput="maxlengthNumber(this);" class="formulario__input" autofocus name="id"
                        title="Numero de documento" id="document" required
            ...
            <div class="formulario__grupo" id="grupo__name">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" onkeypress="return(textspace(event))" minlength="10" oninput="maxlengthNumber(this);"
            ...
            <div class="formulario__grupo" id="grupo__direccion">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" minlength="10" maxlength="100" oninput="(maxlengthNumber(this))"
                        class="formulario__input" name="direccion" required id="direccion"
            ...
            <div class="formulario__grupo" id="grupo__direccion">
                ...
                <div class="formulario__grupo-input">
                    <input type="file" class="formulario__input" accept="image/jpeg, image/png, image/jpg" name="foto" required id="foto">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                @error('foto')
                    <p class="message">{{ $message }}
            ...
            <div class="formulario__grupo" id="grupo__password">
                ...
                <div class="formulario__grupo-input">
                    <input type="password" onkeypress="validarPassword(event)" minlength="10" maxlength="20"
                        class="formulario__input" name="password" oninput="maxlengthNumber(this);" required
            ...
            <div class="formulario__grupo" id="grupo__telephone">
                ...
                <div class="formulario__grupo-input">
                    <input type="number" minlength="10" class="formulario__input" maxlength="10"
                        onkeypress="return(multiplenumber(event))" name="celular" oninput="maxcelNumber(this);"
                        required id="telephone" placeholder="Ingrese su numero de contacto">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                @error('celular')
                    <p class="message">{{ $message }}
            ...
            <div class="formulario__grupo" id="grupo__datetime">
                ...
                <div class="formulario__grupo-input">
                    <input type="date" class="formulario__input" name="fecha_nacimiento" required id="fecha"
            ...
            <div class="formulario__grupo" id="grupo__datetime">
                ...
                <div class="formulario__grupo-input">
                    <input type="date" class="formulario__input" name="fecha_expedicion" required id="fecha_exp"
                        placeholder="Ingrese su fecha de nacimiento">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error">Debe ingresar su fecha de nacimiento</p>
            ...
            <!-- Container: Saldo Inicial -->

            <div class="formulario__grupo" id="grupo__name">
                <label for="name" class="formulario__label">Saldo Inicial</label>
                <div class="formulario__grupo-input">
                    <input type="number" class="formulario__input" minlength="5" oninput="maxlengthNumber(this);"
                        maxlength="9" name="saldo_inicial" required id="name"
            ...
            <div class="formulario__grupo formulario__grupo-btn-enviar">
                <input type="submit" value="Registrarme"class="formulario__btn">
                <a href="{{ url('login') }}" class="return">Regresar</a>
            </div>
        </form>
    </main>
