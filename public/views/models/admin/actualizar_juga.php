                        ...
                        <div class="col-xl-5 col-lg-5">
                            <div class="card body-card">
                                <div class="card-body tryal">
                                    <h2 style="font-size: 26px;">Actualizar JUGADORES</h2>
                                    <span>ACTUALIZA a los Jugadores de free fire.</span>
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ACTUALIZAR || jugador <?php echo $documento ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="POST" enctype="multipart/form-data" autocomplete="off">
                                            ...
                                            <div class=" mb-3 m-auto">
                                                ...
                                                <a href="./listar_juga.php" class="btn btn-danger">CANCELAR ACTUALIZACION</a>
                                            </div>
