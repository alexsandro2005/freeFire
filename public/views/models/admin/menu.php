...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Admin <?php echo $_SESSION['nombres'] ?></title>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="dashboard_bar">
								Admin <?php echo $_SESSION['nombres'] ?>
                            </div>
                        </div>
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Categorias</a>
								<!-- MODULO PARA ENLISTAR O CREAR UN ADMINISTRADOR -->
                                <ul aria-expanded="false">
                                    <li><a href="email-compose.html">Listar Armas</a></li>
                                    <li><a href="./createWeapon.php">Crear Arma</a></li>
